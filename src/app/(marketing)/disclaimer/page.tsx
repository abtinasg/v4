...
const statements = [
  'Deepin is an analytics and educational platform. We do not execute trades, custody assets, or act as an investment advisor registered under U.S. SEC, FCA, or any other financial authority.',
  ...
  'By using the platform you acknowledge that any loss arising from market activity is your own and you will not hold Deepin, its affiliates, or its employees liable.',
]

export const metadata: Metadata = {
  title: 'Disclaimer | Deep',
  description: 'Important limitations and disclosures about Deepin and its financial research tools.',
}
      ...
      <section className="mx-auto max-w-3xl px-6 py-16 space-y-8">
        <header>
          ...
          <p className="mt-4 text-base text-white/70">
            Last updated: November 30, 2025. Deepin delivers quantitative tools and automation designed for research support only.
        ...
        <article className="rounded-2xl border border-white/10 bg-white/5 p-6 text-sm text-white/80">
          ...
          <p className="mt-3 text-white/70">
            ...
            information presented in Deepin.
          </p>
        </article>
      </section>
    </div>
