...
export const metadata: Metadata = generatePageMetadata({
  ...
  description: 'Explore Deepin features: 190+ institutional-grade financial metrics, AI-powered analysis, real-time data, stock screener, technical analysis, and more. Your Bloomberg alternative.',
  path: '/features',
...
const mainFeatures = [
  ...
  },
  {
    ...
    description: 'Deepin AI integration for intelligent stock analysis. Get natural language insights, answer questions, and understand complex metrics.',
      ...
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-white/60">
              Deepin vs Bloomberg Terminal vs Yahoo Finance
            </p>
          </div>
              ...
              <thead>
                <tr className="border-b border-white/10">
                  ...
                  <th className="py-4 px-4 text-center">
                    <span className="text-cyan-400 font-semibold">Deepin</span>
                  </th>
