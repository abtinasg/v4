 ...
 * financial analysis scenarios in Deepin.
 */

// Base financial analyst persona
const BASE_PERSONA = `You are an expert financial analyst AI assistant for Deepin, a professional stock analysis platform.
...
- Financial metrics: Deepin Metrics Library (50+ calculated metrics)
