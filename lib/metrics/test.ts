...
const mockRawData: RawFinancialData = {
  ...
  fred: {
    ...
    gdpPerCapita: 76000,
    realGDPGrowthRate: 0.024,
    potentialGDP: 22500000000000,
    outputGap: -0.02,
    cpi: 310.5,
    ppi: 280.2,
    coreInflation: 0.032,
    inflationRate: 0.028,
    pceInflation: 0.025,
    coreInflationRate: 0.03,
    breakEvenInflation5Y: 0.024,
    breakEvenInflation10Y: 0.025,
    ...
    primeRate: 0.076,
    interbankRate: 0.053,
    realInterestRate: 0.025,
    neutralRate: 0.025,
    yieldCurveSpread: -0.004,
    yieldCurveSlope: -0.008,
    termPremium: -0.009,
    expectedRealRate: 0.019,
    m1MoneySupply: 18000000000000,
    m2MoneySupply: 21000000000000,
    m2Velocity: 1.12,
    moneyMultiplier: 3.5,
    monetaryBase: 6000000000000,
    excessReserves: 3500000000000,
    quantityTheoryOfMoney: 23520000000000,
    ...
    laborForceParticipation: 0.634,
    employmentPopulationRatio: 0.61,
    initialClaims: 220000,
    continuingClaims: 1850000,
    nonFarmPayrolls: 158000000,
    underemploymentRate: 0.068,
    naturalUnemploymentRate: 0.043,
    wageGrowth: 0.045,
    laborProductivity: 105.2,
    unitLaborCosts: 0.028,
    realWageGrowth: 0.017,
    ...
    buildingPermits: 1480000,
    existingHomeSales: 4100000,
    caseShillerIndex: 315.8,
    ism_pmi: null,
    ism_services: null,
    industrialProduction: 103.2,
    capacityUtilization: 0.789,
    retailSales: 704000000000,
    tradeBalance: -68000000000,
    creditSpread: 0.015,
    tedSpread: 0.0035,
    vix: 18.5,
    financialStressIndex: -0.35,
    chicagoFedIndex: -0.12,
    financialConditionsIndex: -0.12,
    federalDebt: 34000000000000,
    debtToGDP: 123.5,
    budgetDeficit: -1700000000000,
    fiscalImpulse: null,
    fisherEquation: 0.053,
    nominalRiskFreeRate: 0.052,
  },
